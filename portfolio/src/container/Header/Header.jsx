...
const Header = () => {
  ...
  return (
    <div className="app__header app__flex">
        ...
        <div className="app__header-badge">
          <div className="badge-cmp app__flex">
            ...
            <div style={{ marginLeft: 20 }}>
              ...
              <h1 className="head-text">Daipayan</h1>
          ...
          {width > 767 && ( // Adjust the width threshold as necessary
            <div style={{ margin: 120 }} className="app__flex">
              <motion.div
                variants={scaleVariants}
                whileInView={scaleVariants.whileInView}
                className="app__header-circles"
              >
                {[images.typescript, images.vue, images.node].map((circle, index) => (
      ...
      >
        <img src={images.profile} alt="profile_bg" style={{ backgroundColor: 'transparent' }} />
        <motion.img
